      ...
      <div className="table m-auto">
        ...
        {cart.length === 0 ? (
          ...
          cart.map((curElem, index) => {
            return (
              <div
                className="table_data d-flex align-items-center justify-content-between flex-sm-wrap mb-3"
                key={index}
              >
                <div
                  className="img_main d-flex align-items-center flex-wrap"
                  style={{ width: "20%" }}
                >
                  <img
                ...
                <div className="total_price" style={{ width: "24%" }}>
                  <p >
                    <FormatPrice price={curElem.product.price} />
                  </p>
                </div>
                <div className="amount" style={{ width: "20%" }}>
                ...
                <div className="sub_total" style={{ width: "16%" }}>
                ...
                <div className="delete_icon" style={{ width: "20%" }}>
        ...
        <hr />
        <div className="bottom_btn d-flex align-items-center justify-content-between">
          <Link to="/products">
        ...
        {/* SubTotal Section */}
        <div className="bottom_card d-flex justify-content-end">
